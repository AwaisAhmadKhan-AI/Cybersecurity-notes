...
2.Must be unique within the same network at the same time

3.Used for communication between devices
...
1. Firewall allows admin MAC address

2. Attacker spoofs admin MAC → gains access
